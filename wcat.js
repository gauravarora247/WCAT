...
// 4) https://www.tecmint.com/13-basic-cat-command-examples-in-linux/ - for making other commands
...
for(let i =0;i<contentArr.length;i++)
{
  ...
  console.log("data after removing extrea lines ",tempArr);
}

// Till now three commands are ready 
//1.node wcat.js filepath1 -  displaying the content of file 
//2. node wcat.js filepath1 filepath2 filepath3 - displaying the content of all the files 
//3. node wcat.js -s filepath - reducing spacing between the files 
